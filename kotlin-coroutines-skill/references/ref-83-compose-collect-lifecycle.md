...
- **Rule code:** `COMPOSE_001`
- **Tools:** Lint `CollectAsStateWithoutLifecycle`, IntelliJ `CollectAsStateWithoutLifecycle`
- **Suppress:** `@Suppress("CollectAsStateWithoutLifecycle")`
