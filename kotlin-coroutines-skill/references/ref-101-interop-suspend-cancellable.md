...
- **Rule code:** `INTEROP_001`
- **Tools:** Compiler `SUSPEND_COROUTINE_WITHOUT_CANCELLATION`, Detekt `SuspendCoroutineWithoutCancellation`, IntelliJ `SuspendCoroutineWithoutCancellation`
- **Suppress:** `@Suppress("SuspendCoroutineWithoutCancellation")`
