...
- **Rule code:** `FLOW_006`
- **Tools:** Detekt `StateInWithEagerlyStrategy`, Lint `StateInWithEagerlyStrategy`, IntelliJ `StateInWithEagerlyStrategy`
- **Suppress:** `@Suppress("StateInWithEagerlyStrategy")`
