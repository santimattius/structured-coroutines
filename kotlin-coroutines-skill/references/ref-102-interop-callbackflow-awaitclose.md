...
- **Rule code:** `INTEROP_002`
- **Tools:** Compiler `CALLBACK_FLOW_WITHOUT_AWAIT_CLOSE`, Detekt `CallbackFlowWithoutAwaitClose`, IntelliJ `CallbackFlowWithoutAwaitClose`
- **Suppress:** `@Suppress("CallbackFlowWithoutAwaitClose")`
