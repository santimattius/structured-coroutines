...
| 8.2 | Lifecycle-aware Flow (Android)              | ❌                 | ❌                                             | ✅ LifecycleAwareFlowCollection | ⚠️ Android             | Lint: LifecycleAwareFlowCollection detects flow collect in lifecycleScope without repeatOnLifecycle/flowWithLifecycle; ARCH_002 + doc link.   |
