...
| 7.1 | Channel not closed                          | ❌                 | ✅ ChannelNotClosed                           | ✅ (to implement)        | ⚠️ Heuristic           | Heuristic: Channel() without close() on any path; produce closes automatically. Compiler: complex flow analysis.                            |
| 7.2 | consumeEach multiple consumers              | ❌                 | ✅ ConsumeEachMultipleConsumers               | ✅ (to implement)        | ⚠️ Heuristic           | Same Channel in multiple launch/async with consumeEach. Heuristic.                                                                          |
