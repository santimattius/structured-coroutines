...
| **IntelliJ**     | Parity with Compiler/Lint + quick fixes/intentions                 | 1.4, 4.6, 5.3, 6.3, 7.1, 7.2, 9.1 | 8.2 implemented (LifecycleAwareFlowCollection); 6.1 intention Convert to runTest; 4.1 quick fixes (ensureActive, yield, delay). |
